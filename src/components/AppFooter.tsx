...
const socialLinks = [
  ...
  'whatsapp|https://wa.me/message/5ILFWJRPNZE5O1'
];
        ...
        <Row className="row mx-0 text-left">
          ...
          <RevealOnScroll
            ...
            <Col xs={6} md={3} className="__legal __group mb-4 ps-md-0">
              ...
              <Box>
                <Anchor href="/legal">Terms of Use</Anchor>
              </Box>
              <Box>
          ...
          <RevealOnScroll
            ...
            <Box as="p" className="d-flex">
              ...
              <Anchor href="tel:+2349060346075" className="d-inline-flex align-items-center">
                ...
                <Box as="span">
                  +234 906 034 6075 <Box as="small">(9:00am - 9:00pm)</Box>
                </Box>
              </Anchor>
            </Box>
            <Box as="p" className="d-flex">
              ...
              <Anchor href="tel:+2348081951702" className="d-inline-flex align-items-center">
                <SVGIcon name="phone" className="me-2" />
                <Box as="span">
                  +234 808 195 1702 <Box as="small">(24 hrs)</Box>
                </Box>
              </Anchor>
            </Box>
            <Box as="p" className="d-flex">
              <Box as="i" className="fas fa-phone-alt me-2 mt-1"></Box>
              <Anchor href="tel:+23413438299" className="d-inline-flex align-items-center">
                <SVGIcon name="phone" className="me-2" /> +234 01 343 8299
              </Anchor>
            </Box>
            {/* <Box as="p" className="d-flex">
              <Box as="i" className="me-2 mt-1"></Box>
              <Anchor
                href="https://wa.me/message/5ILFWJRPNZE5O1"
                className="d-inline-flex align-items-center">
                <SVGIcon name="whatsapp" className="me-2" /> Chat with us
              </Anchor>
            </Box> */}
          </RevealOnScroll>
        </Row>

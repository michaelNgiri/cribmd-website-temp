...
export const individualBenefitsData: {
  ...
  },
  {
    ...
    list: [
      ...
      { content: 'checked', header: '7 Days Duration' },
      { content: 'checked', header: '24/7 Technical support' },
      { header: 'Advanced diagnostics' },
      { content: 'checked', header: 'Access to the Telemedicine-enabled App' },
      { header: 'Fertility' },
      { header: 'Maternity' },
      { content: 'checked', header: 'Access to Instant Telemedical Consultation' },
      // { content: 'checked', header: 'Drug Prescription' },
      { header: 'Dental Care' },
      { header: 'Eye Care' }
    ],

    list1: '1 person, No visits',
